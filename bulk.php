...
<body class="cbp-spmenu-push">
      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                  <a data-toggle='modal' data-id='' href='#Useradd' class='open-adduser'><i class="fa fa-user"></i>Add Record</a>
        ...
        <thead>
            <tr>
                <th>Students' Record bulk registration upload from Excel</th>
                             
                <th>&nbsp;</th>
                 
               <?php
            				                                      
		           echo"<th><a href='bulk_sample.php?ids=1'> <i class='fa fa-download'></i></a>&nbsp;<a href='groups_.php'> <i class='fa fa-refresh'></i></a>&nbsp;<a href='administrator.php'> <i class='fa fa-close'></i></a></th>";										             			 	
					...
					<!-- start content_slider -->
					     <div class="container">
					     	<ol>
					     		...
					     		<li>Fill the record details in the columns of the file</li>
					     		<li>Save the file as CSV not as xls </li>
					     		<li>Upload the file</li>
					        </ol>
                        </div>
                        SAMPLE FORMAT&nbsp;<a href='bulk_sample.php?ids=1'><i class="fa fa-envelope"></i></a>&nbsp;
	...
	<!--footer-->
	<div class="footer">
	   <p>  <a href="#" target="">© 2021 . All Rights Reserved | Design and developed by UNIMED ICT</a></p>		
	</div>
    <!--//footer-->
	</div>
